...
-- ============================================================================
-- Decisión de diseño (function vs. procedure) -- ver INFORME_PROYECTO.md, seccion 7:
...
AS $$
    ...
    -- caller, igual que el resto de este archivo (ver INFORME_PROYECTO.md, seccion 5).
...
COMMENT ON FUNCTION olimpiadas.f_normalizar(TEXT) IS
    ...
    'INFORME_PROYECTO.md, seccion 5, auditoría 2026-09-13: Paweł/Pawel, González/Gonzalez, '
...
-- (por eso NOC no tiene FK directa a ATLETA -- ver INFORME_PROYECTO.md, seccion 2).
...
-- INFORME_PROYECTO.md, seccion 5, "No hay FK directa NOC → ATLETA" / entidades históricas
...
-- ============================================================================
-- Homónimos (ver INFORME_PROYECTO.md, seccion 5, auditoría 2026-09-13: "Jack Robinson",
...
BEGIN
    ...
    LEFT JOIN olimpiadas.participacion part ON part.atleta_id = a.atleta_id
        ...
        AND (p_incluir_yog IS TRUE OR NOT EXISTS (
            SELECT 1 FROM olimpiadas.edicion_olimpica e4
            WHERE e4.edicion_id = part.edicion_id AND e4.tipo LIKE '%YOG%'))
