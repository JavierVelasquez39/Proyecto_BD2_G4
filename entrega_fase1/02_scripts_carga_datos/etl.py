...
Ver INFORME_PROYECTO.md (seccion 4) para el detalle y la estrategia
documentada para cuando se disponga de esos archivos localmente.
...
REF_EDITIONS = BASE_DIR / "reference_editions.csv"  # fallback residual, ver INFORME_PROYECTO.md (seccion 5)
...
# residuales (ver INFORME_PROYECTO.md, seccion 5, tema de sedes/ediciones).
...
# patrón de corrupción que bios.csv.NOC en fuente 1, ver INFORME_PROYECTO.md, seccion 5). Solo
...
EVENT_SPORT_OVERRIDE = {
    ...
    # muchas más atletas). Ver INFORME_PROYECTO.md, seccion 5.
...
def name_match_key(s):
    ...
    tildes/diacríticos (ver auditoría 2026-09-13 en INFORME_PROYECTO.md, seccion 5: 4 de 30
    ...
    de combinantes (ver INFORME_PROYECTO.md, seccion 5, hallazgo 2026-09-14): NFKD solo
...
def build_sede_edicion(athlete_events: pd.DataFrame, olympics_f3_2024: pd.DataFrame,
    ...
    - 2018 Invierno, 2020 Verano, 2022 Invierno: NINGUNA fuente real trae City
      ...
      INFORME_PROYECTO.md, seccion 5, tema de sedes/ediciones).
    """
    ...
    REPORT.note(f"SEDE: {len(sede_df)} sedes; EDICION_OLIMPICA: {len(edicion_rows)} ediciones. "
                ...
                f"(fuente 2 no llega, fuente 3 es solo Verano); ver INFORME_PROYECTO.md, seccion 5.")
...
# INFORME_PROYECTO.md, seccion 5). Nunca se usa para 1896-2020 (ya cargado desde fuente 1).
# ---------------------------------------------------------------------------
def build_atleta_extension_f3(atleta_df: pd.DataFrame, f3_2024: pd.DataFrame,
    ...
    (limitación conocida, documentada en INFORME_PROYECTO.md, seccion 8): esos campos quedan
    NULL para los atletas nuevos.

    Criterio de emparejamiento (revisado 2026-09-13 tras auditoría manual de
    60 casos, ver INFORME_PROYECTO.md, seccion 5): el emparejamiento por nombre exacto solo
    ...
    REPORT.note(
        ...
        f"Ver auditoría manual y criterio revisado en INFORME_PROYECTO.md, seccion 5."
    )
...
# 2026-09-13 en INFORME_PROYECTO.md, seccion 5: un escaneo sistemático de similitud reveló que
...
def build_participacion_resultado_f3(df_f3_resolved: pd.DataFrame, atleta_id_by_player: dict,
    ...
    if n_dup:
        REPORT.note(f"Fuente 3 (2024): {n_dup} filas comparten (atleta_id, edicion_id, "
                    ...
                    f"existente. Se deduplican igual que el caso Polo 1900 (ver INFORME_PROYECTO.md, seccion 5), "
    ...
    # fuente 3 no trae Age/Height/Weight (ver INFORME_PROYECTO.md, seccion 8): quedan NULL.
...
# está cubierto por fuente 1). Opcional, ver INFORME_PROYECTO.md, seccion 5.
# ---------------------------------------------------------------------------
def cross_check_fuente2(atleta_df: pd.DataFrame, athlete_events: pd.DataFrame):
    ...
    REPORT.section(
        ...
        f"que fuente 1 (1,834 atletas, ver `INFORME_PROYECTO.md`, seccion 5); los conteos no son directamente "
...
def main():
    ...
    REPORT.note(
        ...
        f"(ver INFORME_PROYECTO.md, secciones 3 y 5)."
    )
